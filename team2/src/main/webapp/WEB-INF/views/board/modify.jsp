...
<table>
	...
	<tr>
		<td>
			<label>제목</label>
			<input type="text" name="title" value="${view.title}" class="title"/>
		</td>
	<tr>
		<td>
			<label>작성자</label>
			<input type="text" name="writer" value="${view.writer}" class="title"/>
		</td>
	</tr>
	<tr>
		<td>
			<label>내용</label>
			<textarea cols="100" rows="10" name="content">${view.content}</textarea>
		</td>
	</tr>
	<tr>
		<td>
