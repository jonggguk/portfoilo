...
<body>
	<div id="wrap">
		...
		<center>
				...
				<table class="type09">
					<thead>
						<tr>
							...
							<th scope="cols">회원 탈퇴하기</th>
						</tr>
					</thead>
					<tbody>

						<tr>
							<th scope="row">아이디 입력</th>
							<td><input type="text" name="u_id" id="u_id" size="10"
								value=""></td>
						</tr>
						<tr>
							<th scope="row">비밀번호 입력</th>
							<td><input type="password" name="u_pw" id="u_pw" size="10">
			...
			<c:if test="${msg == false }">
				<p style="color: red">ID와 비밀번호를 확인해주세요 .</p>
			</c:if>
			<br> <br> <br>
