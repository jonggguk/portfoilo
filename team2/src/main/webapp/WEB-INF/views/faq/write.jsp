...
<form method="post">
	<tr>
		<td>
			<label>제목</label>
			<input type="text" name="f_title" class="title"/><br />
		</td>
	</tr>
	<tr>
		<td>
			<label>분류</label>
			<input type="text" name="f_category" class="title"/><br />
		</td>
	</tr>
	<tr>
		<td>
			<label>작성자</label>
			<input type="text" name="u_id" class="title"/><br />
		</td>
	</tr>
	...
	<tr>
		<td>
			<label>내용</label>
			<textarea cols="100" rows="10" name="f_content" >
			</textarea>
			<br />
		</td>
	</tr>
