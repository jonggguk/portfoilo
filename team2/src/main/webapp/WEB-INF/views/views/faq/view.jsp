...
<table>
	...
	<tr>
		<td>
			<div class="s_button">
				<input type="button" value="수정" onclick="location.href='/team2/faq/modify?f_num=${view.f_num}'">
				<input type="button" value="삭제" onclick="location.href='/team2/faq/delete?f_num=${view.f_num}'">
