	...
	<div id="nav">
		<div class="menu">
			<ul class="myMenu">
				...
				<li class="menu4"><p>
						<a href="/team2/review/list">후 기 </a>
					</p></li>
			</ul>
		</div>
	</div>
...
<div>
	...
	<c:if test="${page.prev}">
		<span>[ <a href="/team2/review/list?num=${page.startPageNum - 1}${page.searchTypeKeyword}">이전</a> ]</span>
	</c:if>
	...
	<c:forEach begin="${page.startPageNum}" end="${page.endPageNum}" var="num">
		<span>
			...
			<c:if test="${select != num}">
				<a href="/team2/review/list?num=${num}${page.searchTypeKeyword}">${num}</a>
			</c:if> 			
...
<script>
	...
	document.getElementById("searchBtn").onclick = function () {
		...
		location.href = "/team2/review/list?num=1" + "&searchType=" + searchType + "&keyword=" + keyword;
	};
</script>
</center>
