...
<body>
	...
	<div id="wrap">
		...
		<%-- 
        	if(u_id==null){
        --%>
					<li><a href="/team2/login">LOGIN</a></li>
		<%--  
        	}else{
        --%>
					<li><a href="/team2/main">HOME</a></li>
		<%-- 
        	}
        --%>
					<li><a href="list">JOIN</a></li>
					<li><a href="/team2/mypage">MY PAGE</a></li>
					<li><a href="/team2/cart">CART</a></li>
				</ul>
			</div>
...
<table>
		...
		<c:forEach items="${list}" var="list">
			<tr>
				<td>${list.n_num}</td>
				<td>
					<a href="/team2/notice/view?n_num=${list.n_num}">${list.n_title}</a>
				</td>
				<td>
					<fmt:formatDate value="${list.n_date}" pattern="yyyy-MM-dd" />				
				</td>
				<td>${list.u_id}</td>
			</tr>
		</c:forEach>
