...
<table>
	...
	<tr>
		<td>
			<div class="s_button">
				<input type="button" value="수정" onclick="location.href='/team2/notice/modify?n_num=${view.n_num}'">
				<input type="button" value="삭제" onclick="location.href='/team2/notice/delete?n_num=${view.n_num}'">
